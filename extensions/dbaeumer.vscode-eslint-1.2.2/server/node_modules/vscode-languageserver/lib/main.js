...
class RemoteWindowImpl {
    ...
    showErrorMessage(message, ...actions) {
        return this._connection.sendRequest(protocol_1.ShowMessageRequest.type, { type: protocol_1.MessageType.Error, message, actions });
    }
    showWarningMessage(message, ...actions) {
        return this._connection.sendRequest(protocol_1.ShowMessageRequest.type, { type: protocol_1.MessageType.Warning, message, actions });
    }
    showInformationMessage(message, ...actions) {
        return this._connection.sendRequest(protocol_1.ShowMessageRequest.type, { type: protocol_1.MessageType.Info, message, actions });
    }
}
